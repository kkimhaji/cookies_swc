module.exports = function(app, OBJ)
{
    ...
    // GET SINGLE OBJECTS
    app.get('/api/objs/:obj_id', function(req, res){
        OBJ.findOne({_id: req.params.obj_id}, function(err, obj){
    ...
    // UPDATE THE OBJECTS
    app.put('/api/objs/:obj_id', function(req, res){
    ...
    // DELETE OBJECTS
    app.delete('/api/objs/:obj_id', function(req, res){
